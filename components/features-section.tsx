  ...
  return (
    <section id="features" className="py-16 bg-neutral-50">
      <div className="max-w-4xl mx-auto px-6">
        ...
        {/* ACCORDION */}
        <div className="mb-16">
          <h2 className="text-2xl font-medium text-neutral-900 mb-6">Cosa fa Verbalist</h2>
                ...
                >
                  <AccordionTrigger className="hover:no-underline px-6 py-5">
                    <div className="text-left flex-1">
                      ...
                      <div className="text-[14px] text-neutral-600">{item.description}</div>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="px-6 pb-6">
                    <div className="space-y-4 pt-4 border-t border-neutral-100">
                      <div>
                        ...
                        <p className="text-[14px] text-neutral-700 leading-relaxed">{item.details.cosa}</p>
                      </div>
                      <div>
                        <div className="text-[13px] font-medium text-neutral-500 mb-1">Perché è importante</div>
                        <p className="text-[14px] text-neutral-700 leading-relaxed">{item.details.perche}</p>
                      </div>
                      <div>
                        <div className="text-[13px] font-medium text-neutral-500 mb-1">Risultato</div>
                        <p className="text-[14px] text-neutral-700 leading-relaxed">{item.details.risultato}</p>
                      </div>
                    </div>
                  </AccordionContent>
                </AccordionItem>
        ...
        {/* USE CASES */}
        <div>
          <h2 className="text-2xl font-medium text-neutral-900 mb-6">Due modalità</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-neutral-200 rounded-lg p-6">
              ...
              <p className="text-[14px] text-neutral-500 mb-4">Crea da zero, basandoti sui competitor</p>
              <p className="text-[14px] text-neutral-600 mb-4 leading-relaxed">
              ...
              <div className="pt-4 border-t border-neutral-100">
                ...
                <ul className="space-y-1.5">
                  <li className="text-[14px] text-neutral-700 flex items-start gap-2">
            ...
            <div className="bg-white border border-neutral-200 rounded-lg p-6">
              ...
              <p className="text-[14px] text-neutral-500 mb-4">Migliora quello che hai già</p>
              <p className="text-[14px] text-neutral-600 mb-4 leading-relaxed">
