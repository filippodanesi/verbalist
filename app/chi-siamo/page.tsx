...
export const metadata: Metadata = {
  title: "Chi Siamo",
  description: "Verbalist nasce da NUR Digital Marketing: 25+ anni di esperienza SEO e oltre 430 clienti. Il team dietro il software di content generation con AI.",
  alternates: {
    canonical: "/chi-siamo",
  },
  openGraph: {
      ...
      <div className="pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-12">
            <section>
              <h2 className="font-serif text-2xl font-medium tracking-tight text-neutral-900 mb-4">La nostra storia</h2>
            ...
            <section>
              <h2 className="font-serif text-2xl font-medium tracking-tight text-neutral-900 mb-4">La nostra esperienza</h2>
