...
export const metadata: Metadata = {
  title: "Analisi SERP",
  description: "Analizza i top 10 risultati Google per la tua keyword. Estrai URL, title e meta description dei competitor che rankano davvero.",
  alternates: {
    canonical: "/funzionalita/analisi-serp",
  },
  openGraph: {
      ...
      <div className="pt-32 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h1 className="font-serif text-3xl md:text-4xl font-medium tracking-tight text-neutral-900 mb-4">Analisi SERP</h1>
