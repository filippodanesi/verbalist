...
export const metadata: Metadata = {
  ...
  description: "Identifica search intent, topic ricorrenti, struttura heading, word count e segnali E-E-A-T. Scopri perché i competitor rankano.",
  alternates: {
    canonical: "/funzionalita/analisi-pattern",
  },
  openGraph: {
      ...
      <div className="pt-32 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h1 className="font-serif text-3xl md:text-4xl font-medium tracking-tight text-neutral-900 mb-4">Analisi Pattern</h1>
