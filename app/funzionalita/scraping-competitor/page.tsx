...
export const metadata: Metadata = {
  ...
  description: "Estrai i contenuti dei competitor vincenti: struttura heading, argomenti trattati e pattern di successo. Tutto in formato Markdown strutturato.",
  alternates: {
    canonical: "/funzionalita/scraping-competitor",
  },
  openGraph: {
      ...
      <div className="pt-32 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-8">
            ...
            <h1 className="font-serif text-3xl md:text-4xl font-medium tracking-tight text-neutral-900 mb-4">Scraping Competitor</h1>
